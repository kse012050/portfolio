...
$referer = "http://http://kse012050.cafe24.com/step05/";
...
if(trim($refer) == "kse012050.cafe24.com/step05/"){
    ...
    if($conn){
        ...
        while($row = mysql_fetch_row($dbResult) ){
            ...
            $seq = $row["seq"];
            $password = iconv("EUC-KR","UTF-8", $row[0]);
            $title = iconv("EUC-KR","UTF-8", $row[1]);
            $link = iconv("EUC-KR","UTF-8", $row[2]);
            $img = iconv("EUC-KR","UTF-8", $row[3]);
